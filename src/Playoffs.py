"""
Turns one simulated season's final standings into actual playoff results:
...
def apply_playoff_format(
    ...
    """
    Takes the output of simulate.simulate_season_once (one row per team, with
    wins/losses) and returns it with two new columns:
    ...
    real NBA tiebreakers (head-to-head, division record, etc.) are a lot more
    ...
    for conference in ("East", "West"):
        ...
        # game2 loser is eliminated, no further use
